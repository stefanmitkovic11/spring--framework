...
public class Consume_RestTemplate {
    ...
    private final String URI2 = "https://dummyapi.io/data/v1/user?limit=10";
    ...
    public ResponseEntity<Object> consumeFromDummyApi(){
        ...
        ResponseEntity<Object> response = restTemplate.exchange(URI2, HttpMethod.GET, entity,Object.class);
