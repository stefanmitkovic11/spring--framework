...
import company.entity.Genre;
import company.entity.MovieCinema;
import company.repository.GenreRepository;
import company.repository.MovieCinemaRepository;
...
//    -------------------------  WEBCLIENT =============================
    ...
    @GetMapping("/mono/{id}")
    public Mono<MovieCinema> readWithWebClientById(@PathVariable("id") Long id){
