...
//    @Pointcut("execution(* company.controller.CourseController.*(..))")
...
//    @Before("execution(* company.controller.CourseController.*(..))")
//    public void beforeAdvice(){
//        logger.info("Logger info ------");
//    }

//    @Pointcut("execution(* company.repository.CourseRepository.findById(*))")
...
//    //within
//    @Pointcut("within(company.controller..*)")
...
//    }
    ...
    @Pointcut("@annotation(company.annotation.Loggable)")
